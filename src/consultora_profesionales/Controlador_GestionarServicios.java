 ...
 * @author italo
 */
public class Controlador_GestionarServicios {
    ...
    public void consultarAvance(ArrayList<Servicio> lista_servicios){
        ...
        System.out.println("-------------------------------");
        System.out.println("*Por favor, especifique el servicio en el que este interesado.");
        System.out.println("*Para ello, ingrese el número del servicio:");
        rtaServ=sc.nextLine();
